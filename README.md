...
* **1653** [KyleBing/rime-wubi86-jidian](https://github.com/KyleBing/rime-wubi86-jidian) ⭐ 1,654 | 🐛 30 | 📅 2026-09-09 - 86五笔极点码表 for Rime （鼠须管 - macOS）（小狼毫 - Windows）五笔输入法
* **1124** [SivanLaai/rime\_pure: rime配置](https://github.com/SivanLaai/rime_pure) ⭐ 1,125 | 🐛 4 | 🌐 C++ | 📅 2026-07-30 - 【rime小狼毫\trime同文：手机/PC一站式配置】九宫格双拼、四叶草九宫格拼音、四叶草拼音、小鹤双拼、极品五笔、QQ五笔、徐码、郑码
...
* **326** [oniondelta/Onion\_Rime\_Files](https://github.com/oniondelta/Onion_Rime_Files) ⭐ 326 | 🐛 0 | 🌐 Lua | 📅 2026-09-15 - Rime 注音&拼音 "洋蔥" 方案（四個注音、一個拼音、兩個形碼）
...
* **76** [rime/rime-ipa](https://github.com/rime/rime-ipa) ⭐ 76 | 🐛 6 | 📅 2021-01-28 - IPA / 國際音標輸入方案
...
* **19356** [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ⭐ 19,367 | 🐛 4 | 🌐 Lua | 📅 2026-09-14 - Rime 配置：雾凇拼音 | 长期维护的简体词库
* **3648** [gaboolic/rime-frost](https://github.com/gaboolic/rime-frost) ⭐ 3,649 | 🐛 14 | 🌐 Lua | 📅 2026-09-16 - 白霜拼音，使用高质量语料，进行分词，重新统计字频、词频，归一化，打造纯净、词频准确、智能的词库。
* **3537** [maomiui/rime](https://github.com/maomiui/rime) ⭐ 3,537 | 🐛 46 | 🌐 Lua | 📅 2026-03-22 - Rime 鼠须管（Squirrel）朙月拼音｜小鹤双拼｜自然码双拼配置
* **1055** [gaboolic/rime-shuangpin-fuzhuma](https://github.com/gaboolic/rime-shuangpin-fuzhuma) ⭐ 1,055 | 🐛 14 | 🌐 Lua | 📅 2026-08-16 - 墨奇音形，支持自然码、小鹤、搜狗、微软双拼,是一个基于字形描述信息、递归拆分，最后取首末双形音托的码表开源的方案，墨奇码的拆分码表已开源，目前已经拆分完成全部的通用规范汉字、常用繁体字，总计支持4万字。
* **333** [ksqsf/rime-moran](https://github.com/ksqsf/rime-moran) ⭐ 333 | 🐛 0 | 🌐 Lua | 📅 2026-09-13 - 自然码及整句辅助方案

## 其他

* **365** [rime/rime-emoji](https://github.com/rime/rime-emoji) ⭐ 365 | 🐛 4 | 🌐 Python | 📅 2026-03-25 - Emoji / 繪文字輸入方案
* **305** [gaboolic/moqi-im-windows](https://github.com/gaboolic/moqi-im-windows) ⭐ 305 | 🐛 28 | 🌐 C++ | 📅 2026-08-18 - 墨奇输入法windows版。已接入librime（中州韵），内置白霜拼音。原生支持AI功能。托盘菜单支持主题替换、输入状态切换等功能。
