...
* 粵語 Yue (Cantonese)
  * **678** [rime/rime-cantonese](https://github.com/rime/rime-cantonese) ⭐ 680 | 🐛 13 | 🌐 Python | 📅 2026-08-13 - Rime Cantonese input schema | 粵語拼音輸入方案
...
* **19254** [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ⭐ 19,277 | 🐛 7 | 🌐 Lua | 📅 2026-09-10 - Rime 配置：雾凇拼音 | 长期维护的简体词库
* **3625** [gaboolic/rime-frost](https://github.com/gaboolic/rime-frost) ⭐ 3,627 | 🐛 13 | 🌐 Lua | 📅 2026-09-10 - 白霜拼音，使用高质量语料，进行分词，重新统计字频、词频，归一化，打造纯净、词频准确、智能的词库。
* **3535** [maomiui/rime](https://github.com/maomiui/rime) ⭐ 3,534 | 🐛 46 | 🌐 Lua | 📅 2026-03-22 - Rime 鼠须管（Squirrel）朙月拼音｜小鹤双拼｜自然码双拼配置
* **1048** [gaboolic/rime-shuangpin-fuzhuma](https://github.com/gaboolic/rime-shuangpin-fuzhuma) ⭐ 1,053 | 🐛 14 | 🌐 Lua | 📅 2026-08-16 - 墨奇音形，支持自然码、小鹤、搜狗、微软双拼,是一个基于字形描述信息、递归拆分，最后取首末双形音托的码表开源的方案，墨奇码的拆分码表已开源，目前已经拆分完成全部的通用规范汉字、常用繁体字，总计支持4万字。
...
* **294** [gaboolic/moqi-im-windows](https://github.com/gaboolic/moqi-im-windows) ⭐ 297 | 🐛 27 | 🌐 C++ | 📅 2026-08-18 - 墨奇输入法windows版。已接入librime（中州韵），内置白霜拼音。原生支持AI功能。托盘菜单支持主题替换、输入状态切换等功能。
