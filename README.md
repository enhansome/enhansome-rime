...
* **1645** [KyleBing/rime-wubi86-jidian](https://github.com/KyleBing/rime-wubi86-jidian) ⭐ 1,650 | 🐛 30 | 📅 2026-09-09 - 86五笔极点码表 for Rime （鼠须管 - macOS）（小狼毫 - Windows）五笔输入法
...
* **40** [pingshunhuangalex/rime-keydo](https://github.com/pingshunhuangalex/rime-keydo) ⭐ 40 | 🐛 1 | 🌐 Lua | 📅 2026-09-10 - 键道·我流：基于Colemak-DH Matrix布局的音形码顶功输入方案，脱胎于星空键道
...
* **19254** [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ⭐ 19,322 | 🐛 6 | 🌐 Lua | 📅 2026-09-10 - Rime 配置：雾凇拼音 | 长期维护的简体词库
* **3625** [gaboolic/rime-frost](https://github.com/gaboolic/rime-frost) ⭐ 3,637 | 🐛 14 | 🌐 Lua | 📅 2026-09-13 - 白霜拼音，使用高质量语料，进行分词，重新统计字频、词频，归一化，打造纯净、词频准确、智能的词库。
...
* **330** [ksqsf/rime-moran](https://github.com/ksqsf/rime-moran) ⭐ 332 | 🐛 0 | 🌐 Lua | 📅 2026-09-13 - 自然码及整句辅助方案

## 其他

* **365** [rime/rime-emoji](https://github.com/rime/rime-emoji) ⭐ 365 | 🐛 4 | 🌐 Python | 📅 2026-03-25 - Emoji / 繪文字輸入方案
* **294** [gaboolic/moqi-im-windows](https://github.com/gaboolic/moqi-im-windows) ⭐ 304 | 🐛 28 | 🌐 C++ | 📅 2026-08-18 - 墨奇输入法windows版。已接入librime（中州韵），内置白霜拼音。原生支持AI功能。托盘菜单支持主题替换、输入状态切换等功能。
